...
from tools import padding, unpickle_data
from metrics import *
...
scope_dect = str2bool('True')
event_dect = str2bool('False')
embedding_dim = int(50)
POS_emb = int(0)
pre_training = str2bool('False')
num_classes = int(2)
max_sent_length = int(100)
num_hidden = int(200)
emb_update = str2bool('False')
tr_lang = 'en'
